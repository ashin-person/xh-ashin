...
<div class="body-box" style="float:right">
	<form id="jvForm" action="${pageContext.request.contextPath }/control/addBrand.bhtml" method="post" enctype="multipart/form-data">
		<table cellspacing="1" cellpadding="2" width="100%" border="0" class="pn-ftable">
			<tbody>
				...
				<tr>
					...
					<td width="80%" class="pn-fcontent">
						<img width="100" height="100" id="allImgUrlId"/>
						<input type="hidden" name="imgUrl" id="pathId"/>
