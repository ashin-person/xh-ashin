...
<%@ include file="/back_page/date.jsp" %>
     <ul class="w-lful">
		<li><a href="${pageContext.request.contextPath }/product/productList.bhtml" target="rightFrame">商品管理</a></li>
		<li><a href="${pageContext.request.contextPath }/control/brand.bhtml" target="rightFrame">品牌管理</a></li>
