...
<div class="w loc">
	<div class="h-title">
		<div class="h-logo"><a href="http://localhost:8080/ashin-demo-web"><img src="${pageContext.request.contextPath }/res/img/pic/logo-1.png" /></a></div>
	    <div class="h-search">
	      	<input type="text" />
	...
	<dl id="cart" class="cart r">
		...
		<dd class="hidden">
			<p class="alg_c hidden">购物车中还没有商品，赶紧选购吧！</p>s
	...
	<div class="r wr">
		...
		<div class="box bg_white">
			<ul class="uls i_150x150 x4_150x150">
				<li>
					<a href="productDetail.jsp" title="富一代" target="_blank" class="pic"><img src="${pageContext.request.contextPath }/res/img/pic/ppp.jpg" alt="依琦莲2014瑜伽服套装新" /></a>
					<dl>
		...
		<h2 class="h2 h2_filter mt"><em title="商品筛选">商品筛选</em><cite><a href="javascript:void(0);" id="filterRest" title="重置筛选条件">重置筛选条件</a></cite></h2>
			<ul class="uls filter">
				...
				<li><b>品牌：</b><p>
					...
					<a href="${pageContext.request.contextPath }/front_page/product/list/display.shtml?brandId=1&brandName=依琦莲&typeName=${typeName }&typeId=${typeId}" title="依琦莲">依琦莲</a>
				...
				<li><b>类型：</b><p>
					<a href="javascript:void(0);" title="不限" class="here">不限</a>
					<a href="${pageContext.request.contextPath }/front_page/product/list/display.shtml?typeId=2&brandId=${brandId }&brandName=${brandName}&typeName=瑜伽服" title="瑜伽服">瑜伽服</a>
			...
			<div class="mt ofc">
				<ul class="uls i_150x150 x4_150x150b">
					<li>
						<a href="${pageContext.request.contextPath }/front_page/product/productDetail.jsp" title="瑜伽服" target="_blank" class="pic"><img src="${pageContext.request.contextPath }/res/img/pic/ppp.jpg" alt="瑜伽服" /></a>
						<dl>
							<!-- dt 10个文字+... -->
							<dt><a href="${pageContext.request.contextPath }/front_page/product/productDetail.jsp" title="依琦莲2014瑜伽服套装新款" target="_blank">依琦莲2014瑜伽服套装新款</a></dt>
							<!-- dt 25个文字+... -->
